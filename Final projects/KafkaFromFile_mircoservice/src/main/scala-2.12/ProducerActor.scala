 ...
 implicit val mat = ActorMaterializer()
  ...
  override def receive: Receive = {
    case startProducer => {
     ...
     val source: Source[ProducerRecord[Array[Byte], String], NotUsed] = Source.fromIterator(() => genomeFile.getLines().toIterator).map{new ProducerRecord[Array[Byte], String]("kafkatopicA", _)}
